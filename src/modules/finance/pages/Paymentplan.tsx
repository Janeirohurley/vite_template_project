          ...
          <SingleSelectDropdown
            ...
            onChange={(selectedId) => {
              ...
              if (type) {
                ...
                setfilterBackend({ [`${type}_fk`]: selectedId });
              }
            }}
      ...
      <DataTable
        ...
        columns={[
          ...
          },
          {
            ...
            label: "État",
            render: (r: PaymentPlan) => (
              <Badge className={`text-[9px] font-semibold ${r.status === 'active' ? 'bg-emerald-50 text-emerald-700 border-emerald-100' : 'bg-slate-100 text-slate-600'
                }`}>
