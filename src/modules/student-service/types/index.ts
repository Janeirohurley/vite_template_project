...
export type UpdateHighSchoolData = Partial<CreateHighSchoolData>;
...
export type UpdateSectionData = Partial<CreateSectionData>;
...
export type UpdateCertificateData = Partial<CreateCertificateData>;
...
export type UpdateOptionData = Partial<CreateOptionData>;
...
export type UpdateTrainingCenterData = Partial<CreateTrainingCenterData>;
...
export type UpdateDocumentRequestData = Partial<CreateDocumentRequestData> & {
  processed_by?: string | null;
  processed_at?: string | null;
};
